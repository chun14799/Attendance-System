...
import SalaryHistoryUser from './Salary/SalaryHistoryUser';
    ...
    return(
        <div>
            <Router>
                ...
                <Route path="/attendances/edit/:id" exact component={AttendancesEdit} />
                ...
                <Route path="/salary/history" exact component={SalaryHistory} />
                <Route path="/salary/user" exact component={SalaryHistoryUser} />
            </Router>
            <ToastContainer
                position="top-right"
                autoClose={5000}
